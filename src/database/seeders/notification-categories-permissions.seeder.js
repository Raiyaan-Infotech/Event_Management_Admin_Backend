#!/usr/bin/env node
/**
 * RBAC rows for the Notification Categories master-data screen (the
 * "Notification Category" dropdown feeding Notification Templates).
 *
 * See notification-templates-permissions.seeder.js for the full rationale —
 * this is the identical pattern for a second module.
 *
 * ── HOW TO RUN ──────────────────────────────────────────────────────────────
 *   node src/database/seeders/notification-categories-permissions.seeder.js
 *   node src/database/seeders/notification-categories-permissions.seeder.js --prod
 */
...
const MODULE = {
    slug: 'notification_categories',
    name: 'Notification Categories',
    description: 'Manage the "Notification Category" dropdown on Notification Templates',
