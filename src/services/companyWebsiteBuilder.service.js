...
const TABLE_COLUMNS = {
  ...
  footer: ['logo_url', 'company_name', 'description', 'contact_type', 'mobile', 'email', 'address', 'top_list_json', 'top_list_heading', 'top_list_heading_2', 'show_quick_links_1', 'show_quick_links_2', 'quick_links_json', 'quick_links_2_json', 'add_pages_json', 'show_newsletter', 'show_social_links', 'copyright_text', 'powered_by_text', 'locked_fields_json', 'design_json', 'is_active'],
