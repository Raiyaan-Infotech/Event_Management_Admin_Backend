...
const UI_CHROME_KEYS = [
  ...
  // ── Client auth screens (login / signup / provider flow) ──────────────────
  // Rendered by sections/login-section.tsx, signup-section.tsx and the shared
  // auth-shared.tsx. {company}, {provider} and {name} are runtime variables —
  // a translation MUST keep the braces or the value is lost.
  ['login.welcome_title', 'Welcome Back!'],
  ['login.welcome_subtitle', 'Log in to your {company} account and continue creating unforgettable moments.'],
  ...
  ['login.mobile_placeholder', 'Enter your mobile number'],
  ['login.otp_label', 'Enter OTP'],
  ['login.otp_sent_to', 'Sent to'],
  ['login.send_otp', 'Send OTP'],
  ['login.forgot_password', 'Forgot password?'],
  ['login.submit', 'Log In'],
  ['login.or', 'OR'],
  ['login.privacy_line_1', 'We take your privacy seriously.'],
  ['login.privacy_line_2', 'Your information is 100% secure.'],
  ['signup.badge', 'Get Started'],
  ['signup.title_line_1', "Let's create something"],
  ['signup.title_highlight', 'unforgettable!'],
  ['signup.subtitle', 'Join thousands of happy users who create stunning invitations and memorable events with {company}.'],
  ['signup.card_title', 'Create Your Account'],
  ...
  ['signup.email_placeholder', 'Enter your email address'],
  ...
  ['signup.mobile_label', 'Mobile Number'],
  ['signup.mobile_placeholder', 'Enter your mobile number'],
  ['signup.otp_label', 'Enter OTP'],
  ['signup.otp_sent_to', 'Sent to'],
  ['signup.send_otp', 'Send OTP'],
  ['signup.submit', 'Create Account'],
  ['signup.or', 'OR'],
  ['signup.legal_prefix', 'By creating an account, you agree to our'],
  ['signup.terms', 'Terms & Conditions'],
  ['signup.legal_and', 'and'],
  ['signup.privacy', 'Privacy Policy'],
  ['auth.number_safe', 'Your number is safe with us. We never share your details.'],
  ['auth.sign_in_with', 'Sign in with {provider}'],
  ['auth.choose_account', 'Choose an account'],
  ['auth.to_continue_to', 'to continue to'],
  ['auth.use_another_account', 'Use another account'],
  ['auth.provider_share_notice', 'To continue, {provider} will share your name, email address, language preference and profile picture with {company}.'],
  ['auth.verifying_account', 'Verifying your account'],
  ['auth.validating_credentials', 'Please wait while we validate your {provider} credentials…'],
  ['auth.may_take_seconds', 'This may take a few seconds. Please do not close this window.'],
  ['auth.almost_there', 'Almost there!'],
  ['auth.mobile_prompt_prefix', 'Please'],
  ['auth.mobile_prompt_accent', 'enter your mobile number'],
  ['auth.mobile_prompt_suffix', 'to secure your account.'],
  ['auth.mobile_label', 'Mobile Number'],
  ['auth.otp_notice', 'We will send you an OTP to verify your mobile number.'],
  ['auth.send_otp', 'Send OTP'],
  ['auth.verify_otp', 'Verify OTP'],
  ['auth.otp_sent_to', "We've sent a 6-digit OTP to"],
  ['auth.edit', 'Edit'],
  ['auth.enter_otp', 'Enter OTP'],
  ['auth.didnt_receive', "Didn't receive the code?"],
  ['auth.resend_in', 'Resend OTP in'],
  ['auth.resend_otp', 'Resend OTP'],
  ['auth.verify_continue', 'Verify & Continue'],
  ['auth.back', 'Back'],
  ['auth.welcome_name', 'Welcome, {name}!'],
  ['auth.login_success', 'You have successfully logged in to your account.'],
  ['auth.go_to_dashboard', 'Go to Dashboard'],
  ['auth.or', 'OR'],
  ['auth.explore_events', 'Explore My Events'],
  ['auth.start_creating', 'Start creating amazing events'],
  ['auth.start_creating_subtitle', 'Design, manage guests and create unforgettable experiences.'],
  ['login.feature.invitations.title', 'Beautiful Invitations'],
  ['login.feature.invitations.description', 'Create stunning invitations for any event in minutes.'],
  ['login.feature.manage.title', 'Manage Easily'],
  ['login.feature.manage.description', 'Manage guests, RSVPs and communications all in one place.'],
  ['login.feature.track.title', 'Track & Analyze'],
  ['login.feature.track.description', 'Get real-time insights and analytics for your events.'],
  ['login.feature.secure.title', 'Secure & Private'],
  ['login.feature.secure.description', 'Your data is safe with us. We never share your information.'],
  ['signup.feature.easy.title', 'Easy to Use'],
  ['signup.feature.easy.description', 'Create beautiful invitations in minutes with our simple and intuitive tools.'],
  ['signup.feature.templates.title', 'Stunning Templates'],
  ['signup.feature.templates.description', 'Choose from 1,000+ professionally designed templates for any occasion.'],
  ['signup.feature.manage.title', 'Manage with Ease'],
  ['signup.feature.manage.description', 'Track RSVPs, send reminders, and manage guests all in one place.'],
  ['signup.feature.secure.title', 'Secure & Reliable'],
  ['signup.feature.secure.description', 'Your data is safe with us. We use industry-standard security to protect your privacy.'],
  ...
  ['signup.continue_with_facebook', 'Continue with Facebook'],
  ['signup.stat.users', 'Happy Users'],
  ['signup.stat.invitations', 'Invitations Created'],
  ['signup.stat.rating', 'Average Rating'],
  ['signup.stat.uptime', 'Uptime & Reliable'],
  ['auth.password_rule.length', 'At least 8 characters'],
  ['auth.password_rule.number', 'Include a number'],
  ['auth.password_rule.uppercase', 'Include an uppercase letter'],
