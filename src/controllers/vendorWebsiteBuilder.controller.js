...
module.exports = {
  ...
  saveTestimonials: replaceItems('testimonials', 'Testimonials saved'),
  ...
  saveClients: replaceItems('clients', 'Clients saved'),
  ...
  saveSponsors: replaceItems('sponsors', 'Sponsors saved'),
  getPricingSettings: getSingleton('pricingSettings', 'Pricing settings retrieved'),
  savePricingSettings: saveSingleton('pricingSettings', 'Pricing settings saved'),
  listPricingPlans: listItems('pricingPlans', 'Pricing plans retrieved'),
  savePricingPlans: replaceItems('pricingPlans', 'Pricing plans saved'),
  listPricingMatrixFeatures: listItems('pricingMatrixFeatures', 'Pricing matrix features retrieved'),
  savePricingMatrixFeatures: replaceItems('pricingMatrixFeatures', 'Pricing matrix features saved'),
  listFeatures: listItems('features', 'Features retrieved'),
  createFeature: createItem('features', 'Feature created'),
  updateFeature: updateItem('features', 'Feature updated'),
  deleteFeature: deleteItem('features', 'Feature deleted'),
  replaceFeatures: replaceItems('features', 'Features saved'),
  publishWebsite,
};
