...
INSERT INTO `plugins` (`slug`, `name`, `description`, `category`, `icon`, `is_active`, `config_group`, `config_route`, `company_id`) VALUES
  ...
  ('website-management','Website Management','Enable vendor website pages, header, footer, sliders, and public website builder access.','content','globe',0,NULL,NULL,1),
...
ALTER TABLE `vendors`
  ADD COLUMN IF NOT EXISTS `website_enabled` TINYINT(1) NOT NULL DEFAULT 0 AFTER `membership`;
...
-- ═════════════════════════════════════════════════════════════════════════════
-- Vendor Website Builder schema (21 tables) — keep in sync with migration
-- 20260604000200-create-vendor-website-builder-tables.js
-- ═════════════════════════════════════════════════════════════════════════════
...
-- ============================================================
-- Color Palettes (website builder, 4 semantic colors)
-- ============================================================
